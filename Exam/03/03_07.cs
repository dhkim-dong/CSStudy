...
namespace Exam._03
{
    class Customer
    {
        ...
        public virtual int CaclPrice(int price)
        {
    ...
    class VipCustomer : Customer
    {
        ...
        public override int CaclPrice(int price)
        {
            point += price * pointRatio;
    ...
    internal class _03_07
    {
        static void Main7(string[] args)
        {
            ...
            Console.WriteLine("김춘추님이 지불할 금액 : " + kim.CaclPrice(10000));
            Console.WriteLine("이순신님이 지불할 금액 : " + lee.CaclPrice(10000));
